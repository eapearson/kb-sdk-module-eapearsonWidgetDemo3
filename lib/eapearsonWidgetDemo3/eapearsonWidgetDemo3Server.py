...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'eapearsonWidgetDemo3'):
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'eapearsonWidgetDemo3'
        ...
        self.rpc_service.add(impl_eapearsonWidgetDemo3.run_eapearsonWidgetDemo3,
                             name='eapearsonWidgetDemo3.run_eapearsonWidgetDemo3',
                             types=[dict])
        self.method_authentication['eapearsonWidgetDemo3.run_eapearsonWidgetDemo3'] = 'required'  # noqa
        self.rpc_service.add(impl_eapearsonWidgetDemo3.status,
                             name='eapearsonWidgetDemo3.status',
                             types=[dict])
